...
try:
    ...
    # Configurar caminho do Tesseract automaticamente
    tesseract_paths = [
...
# Mapeamento dos nomes amigáveis dos agentes para os nomes reais das tabelas no DB
TABELAS_AGENTE = {
    "Agente RH": "knowledge_hr",
    "Agente TI - Governança": "knowledge_IT GOVERNANCE & DELIVERY METHODS",
    "Agente TI - Desenvolvimento": "knowledge_ARCHITETURE & DEV",
    "Agente TI - Infraestrutura": "knowledge_TECH",
    "Agente TI - Usuário Final": "knowledge_END-USER"
}
            ...
            for i, filepath in enumerate(filepaths):
                try:
                    ...
                    if filepath.lower().endswith('.pdf'):
                        ...
                        # Se PDF não retornou texto significativo, tentar OCR
